...
import qualified Math.Algebra.Group.RandomSchreierSims as Permutation (sgs,isMemberSGS)
...
isMem [] p = p == 1
isMem sgs p = Permutation.isMemberSGS sgs p 
